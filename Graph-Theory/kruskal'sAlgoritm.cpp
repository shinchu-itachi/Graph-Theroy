...
void solve() {
	// first make the structure of the graph ,
	// we will require a linear data structure since we have to sort it also

	// no of nodes
	int n ; cin >> n;

	// vector ds to store the struct node and sort it accordingly
	vector < node > grp;
	for ( int i = 1 ; i <= n ; i ++) {
		int a , b , wt;
		cin >> a >> b >> wt;
	...
	// now our graph is been made
	// now we have to sort it as per the algo
	sort(all(grp) , cmp);
